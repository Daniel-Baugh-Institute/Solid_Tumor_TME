...
F_ResCNPDL1=Res*K_RCNPDL1*CNPDL1*(1-CNPDL1/(Y_CNPDL1M))*1/(alpha_2*CPDL1+1);                                  % Resource-driven proliferation of tumor stem cells
...
F_ResCPDL1=Res*K_RCPDL1*CPDL1*(1-CPDL1/(Y_CPDL1M))*1/(alpha_2*CNPDL1+1);                                     % Resource-driven proliferation of PDL1 +ve cells
