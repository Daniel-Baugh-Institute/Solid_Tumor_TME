function P=ST_parameters_Fibro_Rich(alpha)
...
K_CTCAF=2*10^(-4);
P(32)=K_CTCAF;             % Tumor cells-induced growth of CAF

K_CTCAFR=50;
P(33)=K_CTCAFR;            % Proximity factor for CAF and resistant tumor cells  
...
K_IL8D=5;                  
P(48)=K_IL8D;             % Degradation rate of IL8
end