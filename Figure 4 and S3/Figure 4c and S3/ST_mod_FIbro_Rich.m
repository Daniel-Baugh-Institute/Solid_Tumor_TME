function dydt=ST_mod_FIbro_Rich(t,y,u,P)
...
alpha_c=P(14);             % Space Competition
...
K_CTCAF=P(32);             % Tumor cells-induced growth of CAF

K_CTCAFR=P(33);            % Proximity factor for CAF and resistant tumor cells  
...
F_ResCNPDL1=Res*K_RCNPDL1*CNPDL1*(1-CNPDL1/(Y_CNPDL1M*(1-I)))*1/(alpha_c*(CPDL1+CRPDL1+CRNPDL1)+1);                                  % Resource-driven proliferation of tumor stem cells
...
F_ResCPDL1=Res*K_RCPDL1*CPDL1*(1-CPDL1/(Y_CPDL1M*(1-I)))*1/(alpha_c*(CNPDL1+CRNPDL1+CRPDL1)+1);                                     % Resource-driven proliferation of PDL1 +ve cells
...
F_ResCRNPDL1=Res*K_RCRNPDL1*CRNPDL1*(1-CRNPDL1/(Y_CNPDL1M*I))*1/(alpha_c*(CPDL1+CRPDL1+CNPDL1)+1);                                 % Resource-driven proliferation of tumor stem cells

F_CAFCRNPDL1=(1+K_CAFCR*CAF/(CAF+1));                                                                                    % CAF-driven proliferation of the tumor cells

F_CRNPDL1CRPDL1= K_CPDNPD*CRNPDL1;                                                                                       % Conversion from stem to PDL1, T-exposed tumor cells
...
F_ResCRPDL1=Res*K_RCRPDL1*CRPDL1*(1-CRPDL1/(Y_CPDL1M*I))*1/(alpha_c*(CPDL1+CRNPDL1+CNPDL1)+1);                                    % Resource-driven proliferation of tumor stem cells
