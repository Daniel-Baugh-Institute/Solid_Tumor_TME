...
K_CAFB=P(16);              % Barrier formation rate

K_CPDNPD= P(17);           % NPDL1 to PDL1 conversion

K_CNPDL1D=P(18);           % Death rate of NPDL1

K_CPDL1D=P(19);            % Death rate of PDL1

K_ResD=P(20);              % Degradation of Resources

Delta=P(21);               % Width of the barrier

%% T cell proliferation, interactions, and death

Y_TKNPD1=P(22);            % Carrying capacity for PD1+ T cells

K_TKPD=P(23);              % Proliferation rate of PD1+ T cells 

K_TKNPD=P(24);             % Proliferation rate of PD1- T cells

K_TKPDNPD1=P(25);          % Conversion from PD1+ to PD1- T cells

K_TKPDTEX=P(26);           % Conversion from PD1+ T cels to exhausted T cells  

K_CNPDT=P(27);             % MHC sensing of tumor cells for immune activation

K_CAFT=P(28);              % CAF-driven inhibition of T cells through regulatory T cells.

K_TKPDD=P(29);             % Death rate for killer PD1+ T cells

K_TEXD=P(30);              % Death rate for exhausted T cells

%% CAF proliferation, interactions, and death

Y_CAF=P(31);               % maximum carrying capacity of Fibroblasts

K_CAF=P(32);               % Proliferation rate of CAF cells 

K_OPNCAF=P(33);            % OPN-induced Proliferation rate of CAF cells

K_CTCAF=P(34);             % Tumor cells-induced growth of CAF

K_CTCAFR=P(35);            % Proximity factor for CAF and resistant tumor cells  

K_M2CAF=P(36);             % M2-driven proliferation rate for CAFs 

K_CAFD=P(37);              % Death rate for CAF

%% Macrophages
Y_M= P(38);               % Carrying capacity

K_M1= P(39);               % Growth rate of M1 phase macrophage

K_CANM1= P(40);            % Tumor cells-driven proliferation of macrophages

K_M1M2=P(41);              % Change of polarity

K_M1D= P(42);              % Death rate of M1 phase macrophage 

K_M2= P(43);               % Growth rate of M2 phase macrophage

K_CAFM2= P(44);            % CAF-driven proliferation of M2 macrophages

alpha_TM= P(45);           % Functional approximation of ICAM1 wrt T cells

K_M2D= P(46);              % Death rate of M2 phase macrophage 

%% IL-8 Secretion
K_M2IL8=P(47);             % IL8 secretion by M2

K_CAFIL8=P(48);            % IL8 secretion by CAF

K_CANIL8=P(49);            % IL8 secretion by tumor cells

K_IL8D=P(50);              % Degradation rate of IL8

%% OPN Secretion

K_CAFOPN=P(51);            % OPN secretion by CAF

K_CANOPN=P(52);            % OPN secretion by tumor cells

K_OPND=P(53);              % Degradation rate of OPN

K_OPNknock=P(54);          % Knock_out reaction rate of OPN
%% IFNG Secretion

K_TIFNG=P(55);             % IFNG secretion by T

K_IFNGD=P(56);             % Degradation rate of IFNG
...
F_ResCNPDL1=Res*K_RCNPDL1*CNPDL1*(1-CNPDL1/(Y_CNPDL1M*(1-I)+1))*1/(alpha_C*(CPDL1+CRPDL1+CRNPDL1)+1);                                  % Resource-driven proliferation of tumor stem cells
...
F_ResCPDL1=Res*K_RCPDL1*CPDL1*(1-CPDL1/(Y_CPDL1M*(1-I)+1))*1/(alpha_C*(CNPDL1+CRNPDL1+CRPDL1)+1);                                     % Resource-driven proliferation of PDL1 +ve cells
...
F_ResCRNPDL1=Res*K_RCRNPDL1*CRNPDL1*(1-CRNPDL1/(Y_CNPDL1M*I+1))*1/(alpha_C*(CPDL1+CRPDL1+CNPDL1)+1);                                 % Resource-driven proliferation of tumor stem cells
...
F_ResCRPDL1=Res*K_RCRPDL1*CRPDL1*(1-CRPDL1/(Y_CPDL1M*I+1))*1/(alpha_C*(CPDL1+CRNPDL1+CNPDL1)+1);                                    % Resource-driven proliferation of tumor stem cells
